...
mod.javelin_old = function()
    ...
    DamageProfileTemplates.medium_javelin_smiter_stab_bleed = {
        ...
        default_target = {
            boost_curve_coefficient_headshot = 2.5,
            dot_template_name = "weapon_bleed_dot_javelin_old",
            boost_curve_type = "ninja_curve",
            boost_curve_coefficient = 1,
            attack_template = "stab_smiter",
            power_distribution = {
    ...
    mod.add_buff_template_moonfire_dot("wood_elf", "weapon_bleed_dot_javelin_old", {
		buffs = {
			{
				duration = 4,
...
mod.javelin_live = function()
	...
	DamageProfileTemplates.medium_javelin_smiter_stab_bleed = {
		...
		default_target = {
            boost_curve_coefficient_headshot = 2.2,
            dot_template_name = "weapon_bleed_dot_javelin_live",
            melee_boost_override = 2.8,
            boost_curve_type = "ninja_curve",
            boost_curve_coefficient = 1,
            attack_template = "stab_smiter",
    ...
    -- unchanged
    mod.add_buff_template_moonfire_dot("wood_elf", "weapon_bleed_dot_javelin_live", {
		buffs = {
            {
                duration = 4,
                name = "weapon bleed dot javelin",
