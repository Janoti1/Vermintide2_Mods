...
mod:add_text("quiver_of_plenty_desc", "Kerillian allows temembers in close proximity and herself to restore 5%% of maximum ammunition when hitting a critical hit.")
-- Create Aura (Teambuff with Range)
